#ifndef LAB2ARRAYS_H_
#define LAB2ARRAYS_H_
...
// Need this version when running on my computer
#include "lab2arrays.c"

// Need the below to work on school linux system
