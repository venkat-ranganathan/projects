...
_This will speed up loading websites if there are ads or trackers on the website that are on the filter list, because your computer now doesn't need to load those ads or trackers before you can see the website content!_
