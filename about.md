...
Who is this good for? Everyone, but especially people who don't know how to install a local ad blocker (like family members). You just set this little device on their home network and leave it alone. It won't block everything, but it blocks _a lot more_ than nothing, so it's a net-positive result.
